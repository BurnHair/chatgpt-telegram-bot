...
def main():
    ...
    openai_config = {
        ...
        "vision_model": os.environ.get("VISION_MODEL", "gpt-4-turbo-2024-04-09"),
        ...
        "tts_model": os.environ.get("TTS_MODEL", "tts-az-1"),
        "tts_voice": os.environ.get("TTS_VOICE", "zh-CN-XiaoxiaoMultilingualNeural"),
    }
    ...
    telegram_config = {
        ...
        "tts_prices": [float(i) for i in os.environ.get("TTS_PRICES", "0.015,0.030,0.015").split(",")],
