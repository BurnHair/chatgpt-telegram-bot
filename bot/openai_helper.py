...
GPT_4_VISION_MODELS = ("gpt-4-vision-preview", "gpt-4-turbo-2024-04-09")
GPT_4_128K_MODELS = ("gpt-4-1106-preview", "gpt-4-0125-preview", "gpt-4-turbo-preview")
GPT_ALL_MODELS = (
    GPT_3_MODELS + GPT_3_16K_MODELS + GPT_4_MODELS + GPT_4_32K_MODELS + GPT_4_VISION_MODELS + GPT_4_128K_MODELS
)
...
class OpenAIHelper:
    ...
    async def __common_get_chat_response(self, chat_id: int, query: str, stream=False):
        ...
        try:
            ...
            common_args = {
                "model": (
                    self.config["model"] if not self.conversations_vision[chat_id] else self.config["vision_model"]
                ),
    ...
    async def interpret_image(self, chat_id, fileobj, prompt=None):
        ...
        content = [
            ...
            {"type": "image_url", "image_url": {"url": image, "detail": self.config["vision_detail"]}},
        ]
