...
class SpotifyPlugin(Plugin):
    ...
    def get_spec(self) -> [Dict]:
        ...
        return [
            ...
            },
            {
                ...
                "parameters": {"type": "object", "properties": {"time_range": time_range_param, "limit": limit_param}},
            },
            {
    ...
    def fetch_top_artists(self, time_range="short_term", limit=5) -> Dict:
        ...
        for item in top_artists["items"]:
            results.append({"name": item["name"], "url": item["external_urls"]["spotify"], "__artist_id": item["id"]})
        return {"results": results}
